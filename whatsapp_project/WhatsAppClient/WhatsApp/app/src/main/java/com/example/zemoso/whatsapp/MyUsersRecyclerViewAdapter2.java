 ...
 */
public class MyUsersRecyclerViewAdapter2 extends RecyclerView.Adapter<MyUsersRecyclerViewAdapter2.ViewHolder> {

    private final List<Users> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyUsersRecyclerViewAdapter2(List<Users> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_users2, parent, false);
